...
helping_verb_statements("Cristiano Ronaldo has  7 division titles.")
helping_verb_statements(
        "Their use and control have been a major focus of international relations policy since their debut.")
